...
When a player or individual combatant fires a weapon with firearms fields in
combat, call `dm-combat.sh resolve` instead of standard D&D attack rolls.
...
- Any action assigned to another route by the compiled resolved gameplay profile
