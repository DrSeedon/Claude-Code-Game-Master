...
| `dm-npc.sh` | Create NPCs, update status, manage party members and current locations |
...
| `dm-scene.sh` | Apply a complete scene transition: location, party, time, consequences, and quest objectives |
