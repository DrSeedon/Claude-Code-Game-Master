...
2. Read `../specialists/dungeon-architect.md` and execute it locally with the source passages. A permitted foreground subagent is optional for a large independent generation:

   ```
   Specialist(dungeon-architect):
