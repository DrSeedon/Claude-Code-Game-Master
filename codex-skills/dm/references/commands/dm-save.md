...
Auto-invoke when the player asks to save, end the session, stop for today, or uses an equivalent phrase in another language.
...
Be SPECIFIC. "Party resting" = BAD. "Wilhelm fell asleep in the repaired house, Koschei is watching from the windowsill, and Brenzel's inspection is tomorrow" = GOOD.
